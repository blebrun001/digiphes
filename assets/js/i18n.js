(() => {
  ...
  const translations = {
    es: {
      ...
      "explorePage.placeholder.body": "Bloque placeholder. El contenido de la página Explore se añadirá aquí.",
    ...
    ca: {
      ...
      "explorePage.placeholder.body": "Bloc placeholder. El contingut de la pàgina Explore s'afegirà aquí.",
    ...
    en: {
      ...
      "explorePage.placeholder.body": "Placeholder block. Content for the Explore page will be added here.",
