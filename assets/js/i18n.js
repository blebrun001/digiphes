(() => {
  ...
  const translations = {
    es: {
      ...
      "hero.exploreCta": "Explorar las colecciones",
      "explorePage.meta.title": "Hub IPHES-CERCA | Explorar colecciones",
      "explorePage.meta.description": "Espacio de exploración de las colecciones de IPHES-CERCA.",
      "explorePage.placeholder.title": "Explorar colecciones",
      "explorePage.placeholder.body": "Here you can explore the digitized collections via textual research.",
      "explorePage.results.title": "Resultados",
      "visualizePage.meta.title": "Hub IPHES-CERCA | Visualizar colecciones",
      "visualizePage.meta.description": "Espacio de visualización de las colecciones de IPHES-CERCA.",
      "visualizePage.placeholder.title": "Presentación",
      "visualizePage.placeholder.body": "Contenido placeholder para la futura introducción de visualización.",
      "visualizePage.title": "Visualize",
      "visualizePage.fullscreen.enter": "Enter fullscreen",
      "visualizePage.fullscreen.exit": "Exit fullscreen",
      "visualizePage.body": "This new page will host visual exploration tools for digitized collections.",
      "metrics.title": "Cifras clave",
      "metrics.body": "",
      "metrics.card1.value": "3",
      "metrics.card1.label": "Years: project timeframe",
      "metrics.card2.value": "15",
      "metrics.card2.label": "Collections: archaeological, reference, and experimental",
      "metrics.card4.value": "1",
      "metrics.card4.label": "Unified access hub",
      "collections.title": "Panorámica de colecciones",
      "collectionsEntry.title": "Explorar las colecciones",
      "collectionsEntry.cta": "Vamos",
      "collectionsEntry.visualizeCta": "Visualizar",
      ...
      "roadmapVisual.phase1.title": "Fase de estructuración",
      "roadmapVisual.phase1.body": "Esta primera fase establece las bases conceptuales y técnicas del proyecto. Se definen estándares, modelos de datos y protocolos compartidos, y se prepara la infraestructura central para garantizar una digitalización coherente y escalable.",
      "roadmapVisual.phase2.title": "Fase de despliegue",
      "roadmapVisual.phase2.body": "La segunda fase se centra en implementar el marco en colecciones seleccionadas. Los flujos de trabajo se aplican en la práctica, los equipos reciben apoyo mediante formación y se validan la interoperabilidad y la alineación con FAIR.",
      "roadmapVisual.phase3.title": "Fase de consolidación",
      "roadmapVisual.phase3.body": "La fase final estabiliza y evalúa el sistema a escala de laboratorio. Se realizan ajustes cuando es necesario y una hoja de ruta a largo plazo garantiza la sostenibilidad más allá del marco temporal del proyecto.",
    ...
    ca: {
      ...
      "hero.exploreCta": "Explora les col·leccions",
      "explorePage.meta.title": "Hub IPHES-CERCA | Explorar col·leccions",
      "explorePage.meta.description": "Espai d'exploració de les col·leccions d'IPHES-CERCA.",
      "explorePage.placeholder.title": "Explorar col·leccions",
      "explorePage.placeholder.body": "Here you can explore the digitized collections via textual research.",
      "explorePage.results.title": "Resultats",
      "visualizePage.meta.title": "Hub IPHES-CERCA | Visualitzar col·leccions",
      "visualizePage.meta.description": "Espai de visualització de les col·leccions d'IPHES-CERCA.",
      "visualizePage.placeholder.title": "Presentació",
      "visualizePage.placeholder.body": "Contingut placeholder per a la futura introducció de visualització.",
      "visualizePage.title": "Visualize",
      "visualizePage.fullscreen.enter": "Enter fullscreen",
      "visualizePage.fullscreen.exit": "Exit fullscreen",
      "visualizePage.body": "This new page will host visual exploration tools for digitized collections.",
      ...
      "metrics.body": "",
      "metrics.card1.value": "3",
      "metrics.card1.label": "Anys: durada del projecte",
      "metrics.card2.value": "15",
      "metrics.card2.label": "Col·leccions: arqueològiques, de referència i experimentals",
      "metrics.card4.value": "1",
      "metrics.card4.label": "Hub d'accés unificat",
      "collections.title": "Panoràmica de col·leccions",
      "collectionsEntry.title": "Explorar les col·leccions",
      "collectionsEntry.cta": "Som-hi",
      "collectionsEntry.visualizeCta": "Visualitzar",
      ...
      "roadmapVisual.phase1.title": "Fase d'estructuració",
      "roadmapVisual.phase1.body": "Aquesta primera fase estableix els fonaments conceptuals i tècnics del projecte. Es defineixen estàndards, models de dades i protocols compartits, i es prepara la infraestructura central per garantir una digitalització coherent i escalable.",
      "roadmapVisual.phase2.title": "Fase de desplegament",
      "roadmapVisual.phase2.body": "La segona fase se centra a implementar el marc en col·leccions seleccionades. Els fluxos de treball s'apliquen a la pràctica, els equips reben suport mitjançant formació i es validen la interoperabilitat i l'alineació amb FAIR.",
      "roadmapVisual.phase3.title": "Fase de consolidació",
      "roadmapVisual.phase3.body": "La fase final estabilitza i avalua el sistema a escala de laboratori. Es fan ajustos quan cal i un full de ruta a llarg termini garanteix la sostenibilitat més enllà del marc temporal del projecte.",
    ...
    en: {
      ...
      "hero.cta": "Learn more",
      "hero.exploreCta": "Explore the collections",
      "explorePage.meta.title": "Hub IPHES-CERCA | Explore collections",
      "explorePage.meta.description": "Exploration space for IPHES-CERCA collections.",
      "explorePage.placeholder.title": "Explore Collections",
      "explorePage.placeholder.body": "Here you can explore the digitized collections via textual research.",
      "explorePage.results.title": "Results",
      "visualizePage.meta.title": "Hub IPHES-CERCA | Visualize collections",
      "visualizePage.meta.description": "Visualization space for IPHES-CERCA collections.",
      "visualizePage.placeholder.title": "Presentation",
      "visualizePage.placeholder.body": "Placeholder content for the future visualization introduction.",
      "visualizePage.title": "Visualize",
      "visualizePage.fullscreen.enter": "Enter fullscreen",
      "visualizePage.fullscreen.exit": "Exit fullscreen",
      "visualizePage.body": "This new page will host visual exploration tools for digitized collections.",
      ...
      "collectionsEntry.title": "Explore the collections",
      "collectionsEntry.cta": "Search",
      "collectionsEntry.visualizeCta": "Visualize",
      ...
      "roadmapVisual.phase1.title": "Structuring Phase",
      "roadmapVisual.phase1.body": "This first phase establishes the conceptual and technical foundations of the project. Standards, data models, and shared protocols are defined, and the core infrastructure is prepared to ensure coherent and scalable digitization.",
      "roadmapVisual.phase2.title": "Deployment Phase",
      "roadmapVisual.phase2.body": "The second phase focuses on implementing the framework across selected collections. Workflows are applied in practice, teams are supported through training, and interoperability and FAIR alignment are validated.",
      "roadmapVisual.phase3.title": "Consolidation Phase",
      "roadmapVisual.phase3.body": "The final phase stabilizes and evaluates the system at laboratory scale. Adjustments are made where necessary, and a long-term roadmap ensures sustainability beyond the project timeframe.",
