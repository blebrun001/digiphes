(() => {
  ...
  const translations = {
    es: {
      ...
      "underHood.intro.title": "1) Arquitectura RDF para la digitalizacion del laboratorio",
      "underHood.intro.p1": "La digitalizacion de las colecciones de IPHES-CERCA requiere una arquitectura donde todos los datos del laboratorio (inventario, analisis, procedencia, conservacion y recursos digitales) se publiquen en RDF.",
      "underHood.intro.p2": "RDF (Resource Description Framework) representa la informacion en tripletas sujeto-predicado-objeto. Este modelo de grafo, serializable en Turtle y consultable con SPARQL, permite integrar datos heterogeneos con trazabilidad semantica.",
      ...
      "underHood.crm.title": "2) CIDOC-CRM como base semantica comun",
      "underHood.crm.p1": "Como las colecciones del laboratorio son tipologicamente diversas, se necesita un modelo de referencia comun para garantizar coherencia semantica y interoperabilidad entre dominios.",
      "underHood.crm.p2": "CIDOC-CRM cumple ese papel: define clases y propiedades estables (por ejemplo E22, E53, P46, P108) para alinear objetos, contextos, eventos y actores en un mismo grafo RDF.",
      "underHood.crm.p3": "Con este alineamiento, los datos de colecciones distintas pueden consultarse y razonarse con reglas homogeneas sin perder especificidad disciplinar.",
      ...
      "underHood.semantic.title": "3) Extensiones CRM, ontologias y FAIRness",
      "underHood.semantic.p1": "Para responder a las especificidades de cada coleccion, el modelo base se amplia con extensiones de CIDOC-CRM como CRMarchaeo, CRMsci y CRMgeo.",
      "underHood.semantic.p2": "Ademas se emplean vocabularios controlados y ontologias de referencia (por ejemplo Getty AAT, PeriodO, UBERON, Darwin Core), publicados en RDF/SKOS/OWL.",
      "underHood.semantic.p3": "La combinacion de URIs persistentes, grafos nombrados con procedencia, consultas SPARQL y validacion SHACL refuerza los principios FAIR (Findable, Accessible, Interoperable, Reusable).",
    ...
    ca: {
      ...
      "underHood.intro.title": "1) Arquitectura RDF per a la digitalitzacio del laboratori",
      "underHood.intro.p1": "La digitalitzacio de les col.leccions d'IPHES-CERCA requereix una arquitectura on totes les dades del laboratori (inventari, analisi, proveniencia, conservacio i recursos digitals) es publiquin en RDF.",
      "underHood.intro.p2": "RDF (Resource Description Framework) representa la informacio en tripletes subjecte-predicat-objecte. Aquest model de graf, serialitzable en Turtle i consultable amb SPARQL, permet integrar dades heterogenies amb tracabilitat semantica.",
      ...
      "underHood.crm.title": "2) CIDOC-CRM com a base semantica comuna",
      "underHood.crm.p1": "Com que les col.leccions del laboratori son tipologicament diverses, cal un model de referencia comu per garantir coherencia semantica i interoperabilitat entre dominis.",
      "underHood.crm.p2": "CIDOC-CRM fa aquest paper: defineix classes i propietats estables (per exemple E22, E53, P46, P108) per alinear objectes, contextos, esdeveniments i actors dins d'un mateix graf RDF.",
      "underHood.crm.p3": "Amb aquest alineament, les dades de col.leccions diferents es poden consultar i raonar amb regles homogenies sense perdre especificitat disciplinaria.",
      ...
      "underHood.semantic.title": "3) Extensions CRM, ontologies i FAIRness",
      "underHood.semantic.p1": "Per respondre a les especificitats de cada col.leccio, el model base s'esten amb extensions de CIDOC-CRM com CRMarchaeo, CRMsci i CRMgeo.",
      "underHood.semantic.p2": "A mes, s'utilitzen vocabularis controlats i ontologies de referencia (per exemple Getty AAT, PeriodO, UBERON, Darwin Core), publicats en RDF/SKOS/OWL.",
      "underHood.semantic.p3": "La combinacio d'URIs persistents, grafos anomenats amb procedencia, consultes SPARQL i validacio SHACL reforca els principis FAIR (Findable, Accessible, Interoperable, Reusable).",
    ...
    en: {
      ...
      "underHood.intro.title": "1) RDF architecture for laboratory-wide digitization",
      "underHood.intro.p1": "IPHES-CERCA collections digitization requires an architecture where all laboratory data (inventory, analyses, provenance, conservation, and digital assets) are represented in RDF.",
      "underHood.intro.p2": "RDF (Resource Description Framework) models information as subject-predicate-object triples. Serialized in Turtle and queried with SPARQL, this graph model integrates heterogeneous datasets with explicit semantic traceability.",
      ...
      "underHood.crm.title": "2) CIDOC-CRM as a shared semantic backbone",
      "underHood.crm.p1": "Because the laboratory manages highly diverse collections, a common reference model is required to ensure semantic consistency and cross-domain interoperability.",
      "underHood.crm.p2": "CIDOC-CRM provides that backbone by defining stable classes and properties (for example E22, E53, P46, P108) to align objects, contexts, events, and actors in a single RDF graph.",
      "underHood.crm.p3": "This alignment enables unified querying and reasoning across collections while preserving domain-level specificity.",
      ...
      "underHood.semantic.title": "3) CRM extensions, ontologies, and FAIRness",
      "underHood.semantic.p1": "To capture collection-specific requirements, the core model is extended with CIDOC-CRM extensions such as CRMarchaeo, CRMsci, and CRMgeo.",
      "underHood.semantic.p2": "The stack also uses controlled vocabularies and reference ontologies (for example Getty AAT, PeriodO, UBERON, Darwin Core), published in RDF/SKOS/OWL.",
      "underHood.semantic.p3": "Persistent URIs, provenance-aware named graphs, SPARQL querying, and SHACL validation collectively reinforce FAIR principles (Findable, Accessible, Interoperable, Reusable).",
